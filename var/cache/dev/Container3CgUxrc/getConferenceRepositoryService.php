...
class getConferenceRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ConferenceRepository.php';

        return $container->privates['App\\Repository\\ConferenceRepository'] = new \App\Repository\ConferenceRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
